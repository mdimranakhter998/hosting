...
import { useUpdateapplicationMutation,useGetByIdapplicationQuery } from '../services/applicant/appicantionService';
...
export function MyApplication() {
    ...
    const [application,applicationStatus]= useUpdateapplicationMutation()    
...
useEffect(()=>{
    if (isSuccess){
        applicantDetails.map(e=>{ 
            initialValues.id=e.id            
            initialValues.request_no=e.request_no
            ...
            initialValues.document_type=e.document_type           
            initialValues.address_type=e.address_type           
            initialValues.address=e.address
            initialValues.father_name=e.father_name
            initialValues.pincode=e.pincode
            initialValues.gender=e.gender
            initialValues.name=e.user.name
            initialValues.email=e.user.email
            initialValues.phone=e.user.phone          
            initialValues.is_defected=e.is_defected
            initialValues.is_submited=e.is_submited
            initialValues.user_pk=e.user.id
            // initialValues.photo=e.photo
            // initialValues.address_front=e.address_front
            // initialValues.address_back=e.address_back
            // initialValues.document_file=e.document_file
            // initialValues.owner_file=e.owner_file
            setPhotostate(e.photo)
            setAddfstate(e.address_front)
            setAddbstate(e.address_back)
            setDocstate(e.document_file)
            setOwnerstate(e.owner_file)
...
console.log(values)
    ...
    return (
        <>
            ...
            ):values.is_defected===true && values.is_submited===false?(
                ...
                <Form className='common_css' onSubmit={handleSubmit} >
                    ...
                    <Alert show={show} variant="danger"><ul>{errorShow.map(error=><li>{error}</li>)}</ul></Alert>  
                        ...
                        <Form.Group as={Col} >
                            ...
                            <Form.Select aria-label="Default select example" name="connection_type" value={values.connection_type} onBlur={handleBlur} onChange={handleChange} size="sm">
                                ...
                                {connectionType.data?connectionType.data.map(e=>(
                                 <option value={e.connection_type} onClick={()=>{tensionRef.current.className="hidden";tariffRef.current.className="hidden";phaseRef.current.className="hidden";loadRef.current.className="hidden";setConnectionTypeid(e.id)} }>{e.connection_type}</option>
                              )):null}      
                        ...
                        <Form.Group as={Col}>
                            ...
                            <Form.Select aria-label="Default select example" name="tension_type" value={values.tension_type}  onChange={handleChange} onBlur={handleBlur}  size="sm">
                                <option>---select---</option>
                                <option ref={tensionRef} value={values.tension_type} selected>{values.tension_type}</option>
                    ...
                    <Row className="mb-3">
                        <Form.Group as={Col}>
                            ...
                            <Form.Select aria-label="Default select example" name="tariff" value={values.tariff}  onChange={handleChange} onBlur={handleBlur}  size="sm">
                                <option>---select---</option>
                                <option ref={tariffRef} value={values.tariff} selected>{values.tariff}</option>
                        ...
                        <Form.Group as={Col}>
                            ...
                            <Form.Select aria-label="Default select example" name="phase"  value={values.phase}  onChange={handleChange} onBlur={handleBlur} size="sm">
                                <option>---select---</option>
                                <option ref={phaseRef} value={values.phase} selected>{values.phase}</option>
                    ...
                    <Row className="mb-3">
                        <Form.Group as={Col}>
                            ...
                            <Form.Select aria-label="Default select example" name="load" value={values.load}  onChange={handleChange} onBlur={handleBlur}  size="sm">
                                <option>---select---</option>
                                <option ref={loadRef} value={values.load} selected>{values.load}</option>
                    ...
                    <Row className="mb-3">
                        <Form.Group as={Col}>
                            ...
                            <Form.Select aria-label="Default select example" name="district" value={values.district}  onChange={handleChange} onBlur={handleBlur} size="sm">
                              ...
                              {district.data?district.data.map(e=>(
                                 <option value={e.district} onClick={()=>{blockRef.current.className="hidden";setDistrictid(e.id)}}>{e.district}</option>
                              )):null}                            
                              </Form.Select>
                        ...
                        <Form.Group as={Col}>
                            ...
                            <option>---select---</option>
                            <option ref={blockRef} className="" value={values.block} selected>{values.block}</option>
                            {block.data?block.data.map(e=>(
                                 <option  value={e.block} onClick={()=>{panchayatRef.current.className="hidden";setBlockid(e.id)}}>{e.block}</option>
                              )):null}
                            </Form.Select>
                    ...
                    <Row className="mb-3">
                        <Form.Group as={Col}>
                            ...
                            <option>---select---</option>
                            <option ref={panchayatRef} className="" value={values.panchayat} selected>{values.panchayat}</option>
                            {panchayat.data?panchayat.data.map(e=>(
                                 <option value={e.panchayat} onClick={()=>{villageRef.current.className="hidden";setPanchayatid(e.id)}}>{e.panchayat}</option>
                              )):null}
                        ...
                        <Form.Group as={Col}>
                            ...
                            <option>---select---</option>
                            <option ref={villageRef} className="" value={values.village} selected>{values.village}</option>
                    ...
                    <Row className="mb-3">
                        <Form.Group as={Col}>
                            ...
                            <Form.Select aria-label="Default select example" name="division"  value={values.division}  onChange={handleChange} onBlur={handleBlur} size="sm">
                                ...
                                {division.data?division.data.map(e=>(
                                 <option value={e.division} onClick={()=>{subdivisionRef.current.className="hidden";setDivisionid(e.id)}}>{e.division}</option>
                              )):null}  
                            </Form.Select>
                        ...
                        <Form.Group as={Col}>
                            ...
                            <Form.Select aria-label="Default select example" name="subdivision" value={values.subdivision}  onChange={handleChange} onBlur={handleBlur}  size="sm">
                                <option>---select---</option>
                                <option ref={subdivisionRef} className="" value={values.subdivision} selected>{values.subdivision}</option>
                                {subdivision.data?subdivision.data.map(e=>(
                                  
                                 <option value={e.subdivision} onClick={()=>{sectionRef.current.className="hidden";setSubdivisionid(e.id)}}>{e.subdivision}</option>
                              )):null}     
                            </Form.Select>
                    ...
                    <Row className="mb-3">
                        <Form.Group as={Col}>
                            ...
                            <Form.Select aria-label="Default select example" name="section" value={values.section}  onChange={handleChange} onBlur={handleBlur} size="sm">
                                <option>---select---</option>
                                <option ref={sectionRef} value={values.section} selected>{values.section}</option>
                    ...
                    <Row className="mb-3">
                        <Form.Group as={Col} controlId="formGridF_name">
                            <Form.Label>Name<span className="text-danger" disabled>*</span></Form.Label>
                           
                             <Form.Control type="text" value={values.name}  placeholder="" disabled />
                    ...
                    <Row className="mb-3">
                        <Form.Group as={Col} controlId="formGridtel">
                            <Form.Label>Mobile No.<span className="text-danger" >*</span></Form.Label>                           
                             <Form.Control type="tel" value={values.phone}  placeholder=""  disabled/>
                        ...
                        <Form.Group as={Col} controlId="formGridemail">
                            <Form.Label>Email<span className="text-danger" >*</span></Form.Label>                           
                             <Form.Control type="email" value={values.email}  placeholder=""  disabled   />                        
            ...
            <br />  <br />  <br /><br /><br />  <br />
                ...
                <h4 className='mt-2 common_css' >Your application have been submitted</h4> 
